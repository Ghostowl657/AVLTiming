classdef Aircraft
    properties
        ...
        Nchord %% Nchordwise vortices
        Nspan %% Nspanwise vortices
        %%col 1 is real part, col 2 is positive imaginary root.
    end
    methods
        %% CONSTRUCTOR
        function obj=Aircraft(Wings,Htails,Vtails,Case,Bodies,CG,M,Inert,Name,Nchord,Nspan)
            obj.wings=Wings;
            obj.htails=Htails;
            obj.vtails=Vtails;
            obj.bodies=Bodies;
        ...
        function build_file(obj)
            ...
            for k=1:length(obj.wings)
                obj.wings(k).build_surface(fid,obj.Nchord,obj.Nspan);
            end
